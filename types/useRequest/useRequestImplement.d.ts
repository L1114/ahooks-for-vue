...
declare const useRequestImplement: <TData, TParams extends any[]>(service: Service<TData, TParams>, options?: Options<TData, TParams>, plugins?: Plugin<TData, TParams>[]) => {
    ...
    params: import("@vue/shared").IfAny<[] | TParams | undefined, import("vue-demi").Ref<[] | TParams | undefined>, [[] | TParams | undefined] extends [import("vue-demi").Ref<any>] ? (import("vue-demi").Ref<any> & []) | (import("vue-demi").Ref<any> & TParams) : import("vue-demi").Ref<[] | TParams | undefined>>;
    cancel: () => void;
    refresh: () => void;
    refreshAsync: () => void;
